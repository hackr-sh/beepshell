        ...
        source: {
          ...
          if (modelData.icon && modelData.icon.length > 0) {
            ...
            if (modelData.icon.includes("?path=")) {
              ...
              if (nixPath && nixPath.startsWith("/nix/store/")) {
                ...
                let possiblePaths = [
                  nixPath + "/spotify-linux-32.png",
                  nixPath + "/spotify-linux-24.png",
                  nixPath + "/spotify-linux-48.png",
                  nixPath + "/spotify-linux-64.png",
                  nixPath + "/32.png", 
                  nixPath + "/32x32.png",
                  nixPath + "/48.png",
                  nixPath + "/48x48.png",
          ...
          if (modelData.iconName && modelData.iconName.length > 0) {
            ...
            if (cleanIconName === "spotify-linux-32" || modelData.iconName.includes("spotify")) {
              let spotifyIcon = Quickshell.iconPath("spotify", true) || 
                              Quickshell.iconPath("spotify-client", true) ||
                              Quickshell.iconPath("com.spotify.Client", true) ||
                              Quickshell.iconPath("spotify-linux-32", true)
              if (spotifyIcon) {
                return spotifyIcon
              }
            }
          ...
          Text {
            ...
            text: {
              if (modelData.title) {
                ...
                if (modelData.title.toLowerCase().includes("spotify") || 
                    (modelData.iconName && modelData.iconName.toLowerCase().includes("spotify")) ||
                    (modelData.icon && modelData.icon.toLowerCase().includes("spotify"))) {
                  return "♫"
                }
            ...
            font.pixelSize: {
              if (modelData.title && 
                  (modelData.title.toLowerCase().includes("spotify") || 
                   (modelData.iconName && modelData.iconName.toLowerCase().includes("spotify")) ||
                   (modelData.icon && modelData.icon.toLowerCase().includes("spotify")))) {
                return 14
              }
